...
const Heropage = () => {
  return (
    <div className='min-h-9/10 mt-44 overflow-scroll w-full flex flex-col items-center justify-center'>
        <div className='flex-col gap-6 flex items-center justify-center w-full h-full'>
            <p className='text-6xl font-medium px-[3em] text-white text-center h-full w-full'><FadeText text="Now local execution is automated from detection to deployment" /></p>
